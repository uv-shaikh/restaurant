...
from .views import login,index,register,forgot_pass,otpcheck,newpassword,logout,Book,catewise,productview,add_to_cart,order,edit,delete,add,editprofile,show_mycart,remove_cart
